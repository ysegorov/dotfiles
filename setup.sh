...
ln -sfiv ${cwd}/config/i3 ${cwd}/config/neomutt ${cwd}/config/dunst ${cwd}/config/termite ${cwd}/config/alacritty ${cwd}/config/chromium-flags.conf ${cwd}/config/todotxt ${target}/.config/
